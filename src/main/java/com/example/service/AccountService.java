...
public class AccountService {
    ...
    public Account registerAccount(Account account) throws DuplicateDataException,InvalidRequestException,NullPointerException{
    ...
    public Account authenticateAccount(Account account) throws AuthenticationException,NullPointerException{
